...
public class SimpleServer extends AbstractServer {
	...
	protected synchronized void handleMessageFromClient(Object msg, ConnectionToClient client) throws IOException {
		if (msg instanceof GetBranchReportRequest request) {
			...
			try {
				System.out.println("new request: " + getUserType.toString());
				System.out.println(getUserType.name + ", " + getUserType.password);
				var retval = db_.getUserType(getUserType.name, getUserType.password);
