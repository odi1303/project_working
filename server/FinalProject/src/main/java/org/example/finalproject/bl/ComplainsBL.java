...
//    @Inject
    ...
    public void createDeliveryComplain(int userId, long deliveryId, String description) {
    ...
    public void createRestaurantComplain(int userId, long restaurantId, String description) {
        Optional<User> maybeUser = usersRepository.findById(userId);
        if (maybeUser.isEmpty()) {
            return;
        }
    ...
    public void closeComplain(int complainId) {
    ...
    public void compensateComplain(int complainId, long compensation) {
        Complain comlain = complainsRepository.findById(complainId).get();
